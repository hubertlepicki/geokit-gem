...
class GoogleGeocoderTest < BaseGeocoderTest #:nodoc: all
  ...
  def test_bounds_biasing
    ...
    url = "http://maps.google.com/maps/geo?q=Winnetka&output=xml&ll=34.1976932088498,-118.547160027784&spn=0.247047999999999,0.294914000000006&key=Google&oe=utf-8"
    Geokit::Geocoders::GoogleGeocoder.expects(:call_geocoder_service).with(url).returns(response)
